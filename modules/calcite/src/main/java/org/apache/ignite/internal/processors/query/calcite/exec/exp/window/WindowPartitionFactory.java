...
public final class WindowPartitionFactory<Row> {
    ...
    public StreamWindowPartition<Row> newStreamingPartition(Window.Group grp, List<AggregateCall> calls,
        RelDataType inputRowType) {

        assert WindowFunctions.streamable(grp);

        return createPartition(grp, calls, inputRowType, StreamWindowPartition::new);
    }
