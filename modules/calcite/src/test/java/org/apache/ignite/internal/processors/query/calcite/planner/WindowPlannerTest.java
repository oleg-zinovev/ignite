...
public class WindowPlannerTest extends AbstractPlannerTest {
    ...
    public void testWindow1() throws Exception {
        ...
        assertPlan(sql, publicSchema, nodeOrAnyChild(isInstanceOf(IgniteLimit.class))
            .and(hasChildThat(isInstanceOf(IgniteSort.class)).negate()), "ProjectTableScanMergeRule", "ProjectTableScanMergeSkipCorrelatedRule");
    }
    ...
    public void testWindow2() throws Exception {
        ...
        String sql = "SELECT ID, ROW_NUMBER() OVER () FROM TEST";
        assertPlan(sql, publicSchema, nodeOrAnyChild(isInstanceOf(IgniteLimit.class))
